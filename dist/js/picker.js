...
function makeSlider(element, initVal, onChange) {
    ...
    handle.className = 'rangeslider__handle';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var sliderL = controlL.getElementsByClassName('rangeslider')[0];
    ...
    var sliderS = controlS.getElementsByClassName('rangeslider')[0];
    ...
    var sliderH = controlH.getElementsByClassName('rangeslider')[0];
