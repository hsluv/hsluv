...
(function() {
  ...
  maxChroma = function(L, H) {
    ...
    sub2 = sub1 > (1107 / 125000) ? sub1 : 10 * L / 9033;
    result = Infinity;
  ...
  huslToRgb = function(tuple) {
    var _ref;
    return conv.xyz.rgb(conv.luv.xyz(conv.lch.luv((_ref = conv.husl).lch.apply(_ref, tuple))));
  };

  rgbToHusl = function(tuple) {
    var _ref;
    return conv.lch.husl(conv.luv.lch(conv.xyz.luv((_ref = conv.rgb).xyz.apply(_ref, tuple))));
  };
