...
(function() {
  ...
  root.husl2 = function(H, S, L, noHex) {
    var rgb;
    if (noHex == null) {
      noHex = false;
    }
  ...
  root.rgb2 = function(R, G, B) {
    return conv.lch.husl2(conv.luv.lch(conv.xyz.luv(conv.rgb.xyz([R, G, B]))));
  };

  root.hex2 = function(hex) {
    return conv.lch.husl2(conv.luv.lch(conv.xyz.luv(conv.rgb.xyz(conv.hex.rgb(hex)))));
  };
